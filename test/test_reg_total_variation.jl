...
@testitem "TemporalTotalVariation regularization" tags = [:regularization] setup = [RegTestSetup] begin
    using LinearAlgebra
...
@testitem "Second-order TotalVariation regularization" tags = [:regularization] setup = [RegTestSetup] begin
    using LinearAlgebra
...
@testitem "TotalVariation output_dimnames match the real codomain layout" tags = [:regularization] setup = [RegTestSetup] begin
