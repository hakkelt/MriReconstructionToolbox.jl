...
#   julia --project=benchmark/comparison -t N benchmark/comparison/scripts/run_base.jl --threads=N [--use-mkl]
#
...
# ---- 1-coil adjoint ----
if should_run("Base 1C", "1-Coil Adjoint")
...
# ---- multi-coil adjoint ----
if should_run("Base MC", "Cartesian Adjoint")
