...
#   benchmark/comparison/results/benchmark_<backend>_<n>threads__<section>.json
# into the single file the docs / analysis read
#   benchmark/comparison/results/benchmark_<backend>_<n>threads.json
#
#   julia --project=benchmark/comparison benchmark/comparison/scripts/merge_benchmarks.jl [backend] [threads]
