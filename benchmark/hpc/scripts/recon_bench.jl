...
#
#   julia --project=benchmark/hpc -t 8 benchmark/hpc/scripts/recon_bench.jl \
...
#
# Each invocation writes benchmark/hpc/results/mrt_<backend>_<n>threads__<groupsig>.json.
