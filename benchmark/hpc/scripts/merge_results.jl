...
#   benchmark/hpc/results/mrt_<backend>_<n>threads__<groupsig>.json
# into the single file the comparison suite reads
#   benchmark/hpc/results/mrt_<backend>_<n>threads.json
#
#   julia --project=benchmark/hpc benchmark/hpc/scripts/merge_results.jl [backend] [threads]
